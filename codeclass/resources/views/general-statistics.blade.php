        ...
        <div class="card p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex space-x-2">
                    <div class="relative">
                        <input  id="studentSearchInput" type="text" placeholder="Rechercher un étudiant..." class="w-64 pl-3 pr-10 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <button  id="studentFilterBtn"class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md flex items-center">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function filterStudents() {
        ...
        rows.forEach(row => {
            // You can adjust which columns to search (here: name and ID)
    ...
    // Optional: Filter on button click (in case you want to only filter on click)
