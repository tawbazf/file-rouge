    ...
    <div class="bg-white rounded-lg shadow-md p-8 max-w-md w-full">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-6">
                <label class="flex items-center">
                    <input type="checkbox" name="terms" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" required>
                    <span class="ml-2 text-gray-700">
                        I agree to the
                        <a  class="text-primary">Terms</a>
                        and
                        <a 
            ...
            <button type="submit" class="w-full btn-primary text-white py-2 px-4 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Create Account
            </button>
        </form>
        ...
        <div class="mt-6">
            ...
            <div class="mt-6 grid grid-cols-2 gap-3">
                <a href="{{ route('auth.google.redirect') }}" class="w-full flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50">
                ...
                <a href="{{ route('auth.github') }}" class="w-full flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50">
