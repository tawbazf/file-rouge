    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        @endforeach
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm">
                    <div class="flex justify-between items-start mb-4">
                        <span class="badge-blue px-3 py-1 rounded-full text-xs font-medium">En cours</span>
                        <button class="text-gray-400 hover:text-gray-600">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Introduction au HTML/CSS</h3>
                    <div class="flex items-center text-gray-500 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span class="text-sm">2h restantes</span>
                    </div>
                    <div class="progress-bar">
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm">
                    <div class="flex justify-between items-start mb-4">
                        <span class="badge-yellow px-3 py-1 rounded-full text-xs font-medium">À débuter</span>
                        <button class="text-gray-400 hover:text-gray-600">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" />
                            </svg>
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">JavaScript Basics</h3>
                    <div class="flex items-center text-gray-500 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span class="text-sm">4h estimées</span>
                    </div>
                    <div class="progress-bar">
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm">
                    <div class="flex justify-between items-start mb-4">
                        <span class="badge-green px-3 py-1 rounded-full text-xs font-medium">Presque fini</span>
                        <button class="text-gray-400 hover:text-gray-600">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" />
                            </svg>
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Responsive Design</h3>
                    <div class="flex items-center text-gray-500 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span class="text-sm">30min restantes</span>
                    </div>
                    <div class="progress-bar">
                        <div class="progress-bar-fill-green" style="width: 90%"></div>
                    </div>
                </div>
            </div>
        </div>
